...
class AgeGenderPredictionTask extends AsyncTask<Bitmap[], Void, String[]> {
    // class fields
    ...
    AgeGenderPredictionTask(Context context, AssetManager assets, String modelName, OnResultsCallback callback) {
